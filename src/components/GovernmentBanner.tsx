      ...
      <div className="bg-[#173c38] text-[#f5f1e8]">
        <div className="mx-auto flex w-full max-w-7xl flex-wrap items-center justify-between gap-x-5 gap-y-2 px-6 py-2 text-xs sm:px-10 lg:px-14">
          ...
          <div className="flex items-center gap-4">
            <label className="flex items-center gap-2"><span className="sr-only">Choose language</span><div className="text-xs font-medium text-emerald-100 bg-emerald-900/60 px-2.5 py-1 rounded border border-emerald-700/50">English (Official)</div></label>
