...
export default function HealthCheckPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f1e8] text-[#173c38] flex flex-col">
      <GovernmentBanner />

      <main className="flex-1 max-w-5xl w-full mx-auto px-4 py-8 pb-32">
        <div className="flex items-center justify-between pb-6 border-b border-[#173c38]/15 mb-8">
          ...
          <div className="flex items-center gap-2 text-xs font-semibold text-[#173c38]/70">
            <ShieldCheck size={16} className="text-[#27745e]" />
            Deterministic Compliance Shield
          </div>
        </div>
          ...
          <div className="mt-8 space-y-4">
            ...
            <div className="p-4 rounded-xl border border-[#173c38]/10 bg-[#fffdf8] flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-[#173c38]/70 mt-1">
                  No personal identity card numbers, banking credentials, or unnecessary personal disclosures were detected in the public text area.
                </p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl border border-[#173c38]/10 bg-[#fffdf8] flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-[#173c38]/70 mt-1">
                  Total restructured query length is under the statutory limit, formatted cleanly for immediate copy-pasting.
                </p>
              </div>
            </div>
          </div>
          ...
          {isMunicipalOrState ? (
            ...
            <div className="mt-6 p-4 rounded-xl bg-emerald-50 border border-emerald-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-xs text-[#173c38]/80 mt-0.5">
                  All compliance checks passed. Your request is ready for statutory review and journey tracking.
                </p>
              </div>
              <Link
                href="/review"
